import{_ as b,r as i,c as p,o,k as x,i as r,b as l,F as m}from"./index-ognQujHy.js";const s={};function a(u,t){const n=i("vl");return o(),p(m,null,[x(n,{exp:"f(x) \\in P_2(\\R)"}),t[0]||(t[0]=r("br",null,null,-1)),x(n,{exp:"\\Rightarrow"}),t[1]||(t[1]=l(" 設 ")),x(n,{exp:"f(x) = a_0 + a_1 x + a_2 x^2"}),t[2]||(t[2]=l(" 對應到 ")),x(n,{exp:"\\!\\begin{bmatrix} a_0 \\\\ a_1 \\\\ a_2 \\end{bmatrix}\\! \\in \\R^3"}),t[3]||(t[3]=r("br",null,null,-1)),t[4]||(t[4]=r("br",null,null,-1)),t[5]||(t[5]=l(" 化簡線性變換 ")),x(n,{exp:"T"}),t[6]||(t[6]=l("： ")),x(n,{c:"",exp:`
		\\begin{split}
			T(f(x)) &= f''(x) + 2f'(x) - f(x) \\\\
