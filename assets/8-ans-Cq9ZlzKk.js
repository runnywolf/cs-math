import{_ as m,e as x,c as p,o,i as n,a as s,w as e,g as i,F as d}from"./index-Cy3ykrE4.js";const u={};function b(A,t){const l=x("vl"),r=x("OptionAnswer");return o(),p(d,null,[n(r,{option:"A",answer:!0},{default:e(()=>[t[0]||(t[0]=i(" 跡的定義：")),n(l,{exp:"\\text{tr}(A) = \\sum\\limits_{i=1}^n A_{ii}"}),t[1]||(t[1]=s("br",null,null,-1)),t[2]||(t[2]=i(" 根據 ")),n(l,{c:"",exp:`
			\\begin{split}
