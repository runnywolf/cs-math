import{_ as b,e as i,c as u,o as m,i as l,g as r,a as x,F as p}from"./index-DxRyEaSp.js";const o={};function s(d,t){const n=i("vl");return m(),u(p,null,[l(n,{exp:"A"}),t[0]||(t[0]=r(" 的 row sum 均為 1")),t[1]||(t[1]=x("br",null,null,-1)),l(n,{exp:"\\Rightarrow"}),t[2]||(t[2]=r(" 存在特徵向量 ")),l(n,{exp:"x_1 = \\begin{bmatrix} 1 \\\\ 1 \\end{bmatrix}\\!"}),t[3]||(t[3]=r(" 使 ")),l(n,{exp:`
