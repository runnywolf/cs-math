import{_ as r,r as p,c as o,o as m,b as i,k as s,i as l,F as x}from"./index-pBVmNx-m.js";const b={};function d(u,t){const n=p("vl");return m(),o(x,null,[t[0]||(t[0]=i(" 跡的定義：")),s(n,{exp:"\\text{tr}(A) = \\sum\\limits_{i=1}^n A_{ii}"}),t[1]||(t[1]=l("br",null,null,-1)),t[2]||(t[2]=i(" 根據 ")),s(n,{c:"",exp:`
		\\begin{split}
